...
pub fn write_sheet_footer(merges: &[(u32, u32, u32, u32)], buf: &mut Vec<u8>) {
    ...
    const FOOTER_TAIL: &[u8] = &[
        ,
    ];
...
mod tests {
    ...
    fn only_active_sheet_has_f_selected_bit_set() {
        ...
        assert_ne!(bci_payload(true)[0] & F_SELECTED, 0, "active sheet must have fSelected set");
        assert_eq!(bci_payload(false)[0] & F_SELECTED, 0, "inactive sheet must NOT have fSelected set");
    ...
    fn footer_identifier_varies_between_sheets_rest_stays_fixed() {
        ...
        assert_eq!(buf1.len(), buf2.len(), "footer length must not depend on the generated identifier");
        ...
        assert_eq!(buf1[..id_start], buf2[..id_start], "bytes before the identifier must be identical");
        assert_eq!(buf1[tail_start..], buf2[tail_start..], "bytes after the identifier must be identical");
        assert_ne!(buf1[id_start..tail_start], buf2[id_start..tail_start], "the identifier itself must differ");
    }
}
